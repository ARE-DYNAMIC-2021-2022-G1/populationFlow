# Les fonctions suivantes sont celles communes aux modèles 1 et 2:
...
def repartition_annuelle_1(pays, individus):
...
def mise_a_jour_historique_1(pays, individus, historique_pays, historique_individus):
...
# Les fonctions suivantes sont celles spécifiques au modele 2:

# Nouvelle fonction initialisation

def initialisation_2(nb_pays, nb_individus, nb_annees):
...
def repartition_annuelle_2(pays, individus):
    for k1 in individus.keys():
        acc = 0.0
        p = individus[k1][2]
...
def mise_a_jour_historique_2(pays, individus, historique_pays, historique_individus):
    for k1 in historique_pays.keys():
